...
REQUIRED_FILES = [
    ...
    "integrations/vanilla-bubbles/package.json",
    "integrations/react-bubbles/package.json",
    "integrations/vue-bubbles/package.json",
    "integrations/svelte-bubbles/package.json",
    ...
    "core/bundle/integrations/README.md",
