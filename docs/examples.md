...
Use this page to choose the right official family, visual profile, and starter before asking an assistant to generate code.

This page is about skill examples and request shaping. Real framework integration lives under [integrations/README.md](/Users/c14h14n3/Desktop/pretext/integrations/README.md).

## Official Families

### Runnable families

| Family | Use this when you want | Start from |
| --- | --- | --- |
...
## What A Good Request Should Include

- the family name or a clear equivalent
